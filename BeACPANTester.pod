...
Book::Chinese::BeACPANTester - Be a CPAN Tester
...
有时候安装某个模块完毕之后可能发现出错，想安装回原来的模块。或者您的脚本只能运行在老版本的某个模块之上。请遵循如下步骤
...
个人建议您安装 L<http://strawberryperl.com/|Strawberry Perl>, Strawberry Perl 自带 dmake
