...
本段落仅仅描述如何简单的编写测试和验证测试，更多跟详尽的内容，建议参考《Perl Testing程序高手秘笈》。本书 China-pub, 当当和卓越均可购买，由盛春(chunzi)和蒋永清(joe jiang)翻译。
...
如果你使用一些版本库控制的话，有自动的寻找 repository 模块。Module::Install 有 L<Module::Install::Repository>, Dist::Zilla 有 L<Dist::Zilla::Plugin::Repository>
...
Adam Kennedy 是 CPAN 最多产的作者之一。 L<File::HomeDir>, L<IPC::Run>, L<Perl::Dist>, L<pip>, L<PPI>  etc.
...
יובל קוג'מן (Yuval Kogman), Catalyst n多 Plugin 和 n多 MooseX 的作者。L<Moose> 的作者之一。L<KiokuDB> 的发起者
